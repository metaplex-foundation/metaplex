    ...
    return (
      <Html lang="en">
        <Head>
          ...
          <meta
            name="description"
            content="Yet now it's a. blindingly fast b. infinite sales. truly. c. altho, your early print #s ensure that it #SeemsRare. d. We're also increasing the minting cost each n every week. :)"
          />
