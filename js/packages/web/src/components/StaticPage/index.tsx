...
export const StaticPage = (props: {
  ...
  const liveAuctions = auctions.sort(
    (a, b) => a.auction.info.endedAt?.sub(b.auction.info.endedAt || new BN(0)).toNumber() || 0
  )
  ...
  const leftSection = props.leftContent && (
    <section id='left-container' className='author-container'>
      <img src={props.leftContent?.author.avatar} className='author-avatar' alt='author image' />
        ...
        <div key={i} className='mid-section-item'>
          ...
          {section.caption && (
            <p className='image-caption'>
              ...
              <a href={section.caption.linkUrl} rel='noreferrer' target='_blank'>
