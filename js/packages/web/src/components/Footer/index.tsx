      ...
      <div className='footer-info'>
        {footerConf.showShopName ? (
          <div className='footer-community subscriber-container'>
            <div className='sub-header'>{/*LABELS.STORE_NAME*/} Stay up to date</div>
            ...
            <div className='social-media-bar'>
              <div>
                {' '}
                <img className='social-photo img-paddin' src='/twitter.png' alt='twitter' />
              </div>
              <div>
                {' '}
                <img className='social-photo img-paddin' src='/instagram.png' alt='twitter' />
              </div>
              <div>
                {' '}
                <img className='social-photo img-paddin' src='/discord.png' alt='twitter' />
              </div>
            </div>

            <div className='logo-paddin'>
              {' '}
              <img className='footer-logo' src='/footer-logo.png' alt='twitter' />
            </div>
          </div>
        ) : null}
          ...
          <div className='footer-section-container' key={ii}>
            ...
            {component.links.map((link, jj) => (
              <div className='body-text' key={jj}>
                <a className='footer-link' href={link.url} rel='noreferrer' target='_blank'>
                  {link.label}
                </a>
              </div>
            ))}
