...
export const Article: FC<ArticleProps> = ({ className, ...restProps }: ArticleProps) => {
  const ArticleClasses = CN(`article w-full`, className)
  const { isDesktop, isMobile } = useViewport()

  return (
    <div className={ArticleClasses} {...restProps}>
        ...
        <div className='container flex flex-col'>
          <div className='container__wrapper mx-auto max-w-[1048px]'>
            ...
            <div className='mb-[24px] flex w-full md:mb-[32px] lg:mb-[56px]'>
              <SectionHeading
                heading='Ever-watchful army tail forks gulls Lake-town.'
