...
import { startAuction, ParsedAccount, AuctionManagerV1, AuctionManagerV2 } from '@oyster/common';
...
export async function startAuctionManually(
  ...
  try {
    ...
    await startAuction(auctionManager.info.vault, auctionManager.info.authority, instructions);
