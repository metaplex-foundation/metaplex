import { ArweaveTransaction, Storefront, ArweaveQueryResponse } from '@oyster/common';
...
const fetchFromSource = async (subdomain: string): Promise<Storefront | null> => {
  try {
    ...
    const storefront = {
      ...
      meta: {
        ...
        title:
          values['holaplex:metadata:page:title'] || `Holaplex - ${subdomain} | NFT Marketplace`,
        description:
          values['holaplex:metadata:page:description'] || 'A NFT marketplace generated by Holaplex',
      },
      integrations: {
...
export const getStorefront = async (subdomain: string): Promise<Storefront | undefined> => {
