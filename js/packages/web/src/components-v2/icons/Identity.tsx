...
export const Identity = ({ width = 30, height = 21, ...restProps }: any) => {
  return (
    ...
    >
      ...
      <path d='M22 10L15 10' stroke='white' strokeWidth='2' strokeLinecap='round' />
      <path d='M19 14H15' stroke='white' strokeWidth='2' strokeLinecap='round' />
      <circle cx='7.54352' cy='9.63043' r='1.63043' fill='white' stroke='white' strokeWidth='2' />
      <path
