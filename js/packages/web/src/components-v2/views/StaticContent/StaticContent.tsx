        ...
        <article className="prose max-w-[900px] mx-auto">
          ...
          <div className="flex w-full mb-[20px]">
            <div className="block">
              ...
              <ul>
                <li>
                  The Coachella Collectibles NFT mint and auction are ONLY
                  available on the official marketplace & FTX.US.
                </li>
                <li>
                  NEVER share your FTX account information, seed phrase, or
                  private key with anybody.
                </li>
                <li>
                  Coachella and FTX will NEVER reach out to you directly to
                  offer support, ask for your FTX account information, ask you
                  to connect your wallet, or ask you to send funds to any
                  wallets.
                </li>
                <li>
                  We will post official NFT information ONLY on our website,
                  official social media accounts, or official Discord server. We
                  will NEVER do a surprise drop or a limited sale. You will know
                  in advance when it happens, and it will exclusively come from
                  an official account.
                </li>
              </ul>
            </div>
