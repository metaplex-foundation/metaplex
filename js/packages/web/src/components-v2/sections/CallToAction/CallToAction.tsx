  ...
  return (
    <div className={CallToActionClasses} {...restProps}>
      <div className="container">
        <div className="cursor-pointer flex flex-col rounded-[28px] bg-[linear-gradient(94.38deg,_#448fff_1.06%,_#0066D6_107.04%)] pt-[60px] pb-[60px] items-center justify-center text-center gap-[20px] relative">
