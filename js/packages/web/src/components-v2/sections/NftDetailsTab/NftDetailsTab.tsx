  ...
  return (
    <div className={NftDetailsTabClasses} {...restProps}>
      ...
      <div className='flex pt-[4px] w-full'>
        {activeTab === 'attributes' && <AttributesCard list={NftAttributesList} />}
        ...
        {activeTab === 'about' && (
          <div className='w-full p-[20px] text-gray-900 bg-gray-50 border border-gray-100 rounded-[8px] text-md'>
            ...
            artist. Since its inception October 16th, 2021 Belugies. Belugies is a generative NFT
            collection artistically illustrated by a 14 year old artist.
          </div>
        )}
      </div>
    </div>
