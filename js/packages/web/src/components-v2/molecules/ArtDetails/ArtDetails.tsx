...
export const ArtDetails: FC<ArtDetailsProps> = ({
  ...
  const ArtDetailsClasses = CN(
    `art-details w-full pb-[40px] relative`,
    className,
  );
        ...
        <div className="flex pl-[32px] flex-col w-full">
          <div className="flex flex-col mb-[12px]">
            ...
            <span className="text-gray-600 text-md">
              Owned by{' '}
              <a className="cursor-pointer text-B-400 font-500">
                @kasun.peiris
              </a>
            </span>
          </div>
          ...
          <div className="flex flex-col mb-[20px]">
            <label className="text-gray-800 text-h6 mb-[4px]">
              Current price
            </label>

            <div className="flex gap-[4px] items-center">
              <i className="text-lg text-B-400 ri-price-tag-3-fill" />
              <span className="text-gray-800 text-lg font-500 mr-[8px]">
                {price} SOL
              </span>
