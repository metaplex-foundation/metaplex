...
const AdjustQuantitiesStep = ({
  ...
  const shouldRenderSupplyInput = distributionType !== PackDistributionType.Unlimited
  const shouldRenderWeightInput = distributionType !== PackDistributionType.MaxSupply
  ...
  return (
    <div className='quantities-step-wrapper'>
      <p className='quantities-step-wrapper__title'>Set number of cards in pack</p>
      ...
      <div className='quantities-step-wrapper__table-titles'>
        ...
        {shouldRenderWeightInput && (
          <p className='redeem-weight'>
            REDEEM WEIGHT{' '}
            <span>— Weights must be between 1-100. 1 is least likely, 100 is most likely.</span>
          </p>
        )}
      </div>
