...
export const IntroView = () => (
    <div className="has-dropcap">
        ...
        <h2>Come one, come all! Heed the alluring call of the enchanted MAGIC ITEMS bazaar!</h2>
    </div>
