...
export const FaqView = () => {
  return (
    <div className="faq-screen">
      ...
      <br></br>
      <br></br>
      <h3 className="Header2 thug-title"> total supply of the OG thugs? </h3>
      <p className="thug-subtitle">there will only be 3333 OG's</p>
      ...
      <h3 className="Header2 thug-title">
        {' '}
        I won a bird during mint, when will i get it in my wallet?{' '}
      </h3>
      <p className="thug-subtitle">{' '} we will process distribution of the thugs soon after launch</p>
      <h3 className="Header2 thug-title">
        {' '}
        if i'm an OG, when will I recieve my thug?{' '}
      </h3>
      <p className="thug-subtitle">we need a bit of time to process our list of OG's, we will release them asap</p>
      <h3 className="Header2 thug-title">
        {' '}
