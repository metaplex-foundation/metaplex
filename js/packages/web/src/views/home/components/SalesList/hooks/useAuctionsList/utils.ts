...
const participatedAuctionsFilter = (
  ...
  auction.auction.info.bidState.bids.some(b => b.key == bidderPublicKey?.toBase58())
...
const ownAuctionsFilter = (auction: AuctionView, bidderPublicKey?: PublicKey | null): boolean => {
  return (
