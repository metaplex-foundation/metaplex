...
const ClaimingPackStep = ({ numberOfNFTs, numberOfAttempts, metadataByPackCard, creators }: IPropsClaimingPackStep) =>
  (
    <div>
      <p className="modal-redeem__title">Claiming Pack Cards</p>
