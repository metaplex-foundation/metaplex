...
export interface ClaimPackCardsParams extends Pick<MetaState, 'packCards' | 'masterEditions'> {
...
export interface RequestCardsInstructionsParams extends Omit<RequestCardParams, 'index'> {
  cardsLeftToOpen: number
}
