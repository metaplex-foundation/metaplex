...
export interface NexusGenObjects {
  ...
  Store: {
    // root type
    auctionProgram: NexusGenScalars['PublicKey']; // PublicKey!
    key: number; // Int!
    pubkey: NexusGenScalars['PublicKey']; // PublicKey!
    public: boolean; // Boolean!
    tokenMetadataProgram: NexusGenScalars['PublicKey']; // PublicKey!
    tokenProgram: NexusGenScalars['PublicKey']; // PublicKey!
    tokenVaultProgram: NexusGenScalars['PublicKey']; // PublicKey!
  };
  Subscription: {};
  Vault: {
    // root type
