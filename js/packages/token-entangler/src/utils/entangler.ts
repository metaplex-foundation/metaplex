...
import { SPL_ASSOCIATED_TOKEN_ACCOUNT_PROGRAM_ID, TOKEN_ENTANGLEMENT_PROGRAM_ID, WRAPPED_SOL_MINT } from "./ids";
import { ASSOCIATED_TOKEN_PROGRAM_ID, Token, TOKEN_PROGRAM_ID } from '@solana/spl-token';
import { BN } from "@project-serum/anchor";
import { getEdition, getMetadata, getTokenAmount } from "./accounts";
import { decodeMetadata, Metadata } from "@oyster/common/dist/lib/actions/metadata";
...
export async function loadTokenEntanglementProgram(
    ...
    const idl = await anchor.Program.fetchIdl(TOKEN_ENTANGLEMENT_PROGRAM_ID, provider);
