...
export const processPackCards: ProcessAccountsFunc = ({ account, pubkey }, setter) => {
...
const isPackCardAccount = (account: AccountInfo<Buffer>) => account.data[0] === PackKey.PackCard
