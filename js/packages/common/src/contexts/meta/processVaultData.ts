...
import { decodeSafetyDeposit, decodeVault, SafetyDepositBox, Vault, VaultKey } from '../../actions'
import { VAULT_ID, pubkeyToString } from '../../utils'
import { ParsedAccount } from '../accounts/types'
import { ProcessAccountsFunc } from './types'

export const processVaultData: ProcessAccountsFunc = ({ account, pubkey }, setter) => {
...
const isVaultV1Account = (account: AccountInfo<Buffer>) => account.data[0] === VaultKey.VaultV1
