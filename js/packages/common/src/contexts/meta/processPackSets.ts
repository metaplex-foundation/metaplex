...
export const processPackSets: ProcessAccountsFunc = ({ account, pubkey }, setter) => {
...
const isPackSetAccount = (account: AccountInfo<Buffer>) => account.data[0] === PackKey.PackSet
