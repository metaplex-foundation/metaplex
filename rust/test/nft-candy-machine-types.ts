export type NftCandyMachineIDL = {
  version: "0.0.0";
  ...
  instructions: [
    {
      ...
      accounts: [
        ...
        { name: "updateAuthority"; isMut: false; isSigner: true },
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          { name: "mintToVault"; type: "bool" },
          { name: "maxNumberOfLines"; type: "u32" }
        ];
      };
    },
    {
  ...
  errors: [
    ...
    { code: 301; name: "Uninitialized"; msg: "Account is not initialized!" },
    { code: 302; name: "MintMismatch"; msg: "Mint Mismatch!" },
    {
      code: 303;
    ...
    { code: 310; name: "TokenTransferFailed"; msg: "Token transfer failed" },
    { code: 311; name: "CandyMachineEmpty"; msg: "Candy machine is empty!" },
    {
      code: 312;
