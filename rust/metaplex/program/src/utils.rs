...
pub struct CommonRedeemCheckArgs<'p, 'a, 'b> {
    pub program_id: &'p Pubkey,
    pub auction_manager_info: &'a AccountInfo<'b>,
    pub safety_deposit_token_store_info: &'a AccountInfo<'b>,
    pub destination_info: &'a AccountInfo<'b>,
    pub bid_redemption_info: &'a AccountInfo<'b>,
    pub safety_deposit_info: &'a AccountInfo<'b>,
    pub vault_info: &'a AccountInfo<'b>,
    pub auction_info: &'a AccountInfo<'b>,
    pub auction_extended_info: Option<&'a AccountInfo<'b>>,
    pub bidder_metadata_info: &'a AccountInfo<'b>,
    pub bidder_info: &'a AccountInfo<'b>,
    pub token_program_info: &'a AccountInfo<'b>,
    pub token_vault_program_info: &'a AccountInfo<'b>,
    pub token_metadata_program_info: &'a AccountInfo<'b>,
    pub store_info: &'a AccountInfo<'b>,
...
pub struct CommonRedeemFinishArgs<'p, 'a, 'b> {
    pub program_id: &'p Pubkey,
    pub auction_manager: Box<dyn AuctionManager>,
    pub auction_manager_info: &'a AccountInfo<'b>,
    pub bidder_metadata_info: &'a AccountInfo<'b>,
